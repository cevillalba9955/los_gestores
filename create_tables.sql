...
CREATE TABLE LOS_GESTORES.Relleno (
	...
	CONSTRAINT PK_RELLENO PRIMARY KEY(relleno_densidad)
);
...
ADD CONSTRAINT FK_CLIENTE_LOCALIDAD FOREIGN KEY(cliente_localidad) REFERENCES Localidad(localidad_id)

ALTER TABLE LOS_GESTORES.Pedido
ADD CONSTRAINT FK_PEDIDO_CLIENTE FOREIGN KEY(pedido_cliente_id) REFERENCES Cliente(cliente_id)

ALTER TABLE LOS_GESTORES.Pedido
ADD CONSTRAINT FK_PEDIDO_SUCURSAL FOREIGN KEY(pedido_sucursal_nroSucursal) REFERENCES Sucursal(sucursal_nroSucursal)

ALTER TABLE LOS_GESTORES.Detalle_Pedido
ADD CONSTRAINT FK_DETALLE_PEDIDO FOREIGN KEY(detalle_pedido_numero) REFERENCES Pedido(pedido_numero)

ALTER TABLE LOS_GESTORES.Detalle_Pedido
ADD CONSTRAINT FK_DETALL_PEDIDO_SILLON FOREIGN KEY(detalle_pedido_sillon_codigo) REFERENCES Sillon(sillon_codigo)

ALTER TABLE LOS_GESTORES.Factura
ADD CONSTRAINT FK_FACTURA_CLIENTE FOREIGN KEY(factura_cliente_id) REFERENCES Cliente(cliente_id)

ALTER TABLE LOS_GESTORES.Factura
ADD CONSTRAINT FK_FACTURA_SUCURSAL FOREIGN KEY(factura_sucursal_nroSucursal) REFERENCES Sucursal(sucursal_nroSucursal)

ALTER TABLE LOS_GESTORES.Detalle_Factura
ADD CONSTRAINT FK_DETALLE_FACTURA FOREIGN KEY(detalle_factura_numero) REFERENCES Factura(factura_numero)

ALTER TABLE LOS_GESTORES.Detalle_Factura
ADD CONSTRAINT FK_DETALLE_FACTURA_PEDIDO FOREIGN KEY(detalle_factura_pedido_id) REFERENCES Detalle_Pedido(detalle_pedido_id)

ALTER TABLE LOS_GESTORES.Sucursal
ADD CONSTRAINT FK_SUCURSAL_LOCALIDAD FOREIGN KEY(sucursal_localidad) REFERENCES Localidad(localidad_id)

ALTER TABLE LOS_GESTORES.Proveedor
ADD CONSTRAINT FK_PROVEEDOR_LOCALIDAD FOREIGN KEY(proveedor_localidad) REFERENCES Localidad(localidad_id)

ALTER TABLE LOS_GESTORES.Compra
ADD CONSTRAINT FK_COMPRA_PROVEEDOR FOREIGN KEY(compra_proveedor_id) REFERENCES Proveedor(proveedor_id)

ALTER TABLE LOS_GESTORES.Compra
ADD CONSTRAINT FK_COMPRA_SUCURSAL FOREIGN KEY(compra_sucursal_nroSucursal) REFERENCES Sucursal(sucursal_nroSucursal)

ALTER TABLE LOS_GESTORES.Detalle_Compra
ADD CONSTRAINT FK_DETALLE_COMPRA FOREIGN KEY(detalle_compra_numero) REFERENCES Compra(compra_numero)

ALTER TABLE LOS_GESTORES.Detalle_Compra
ADD CONSTRAINT FK_DETALLE_COMPRA_MATERIAL FOREIGN KEY(detalle_compra_material_id) REFERENCES Material(material_id)

ALTER TABLE LOS_GESTORES.Envio
ADD CONSTRAINT FK_ENVIO_FACTURA FOREIGN KEY(envio_factura_numero) REFERENCES Factura(factura_numero)

ALTER TABLE LOS_GESTORES.Sillon
ADD CONSTRAINT FK_SILLON_MODELO FOREIGN KEY(sillon_modelo_codigo) REFERENCES Sillon_Modelo(sillon_modelo_codigo)

ALTER TABLE LOS_GESTORES.Sillon
ADD CONSTRAINT FK_SILLON_MEDIDA FOREIGN KEY(sillon_medida_id) REFERENCES Sillon_Medida(sillon_medida_id)

ALTER TABLE LOS_GESTORES.Sillon
ADD CONSTRAINT FK_SILLON_MATERIAL FOREIGN KEY(sillon_material_id) REFERENCES Material(material_id)

ALTER TABLE LOS_GESTORES.Material
ADD CONSTRAINT FK_MATERIAL_TELA FOREIGN KEY(material_tela_id) REFERENCES Tela(tela_id)

ALTER TABLE LOS_GESTORES.Material
ADD CONSTRAINT FK_MATERIAL_MADERA FOREIGN KEY(material_madera_id) REFERENCES Madera(madera_id)

ALTER TABLE LOS_GESTORES.Material
ADD CONSTRAINT FK_MATERIAL_RELLENO FOREIGN KEY(material_relleno_id) REFERENCES Relleno(relleno_id)

ALTER TABLE LOS_GESTORES.Localidad
ADD CONSTRAINT FK_LOCALIDAD_PROVINCIA FOREIGN KEY(localidad_provincia) REFERENCES Provincia(provincia_id)
